...
use hcf\faction\event\FactionDisbandEvent;
...
final class FactionDisbandCommand extends FactionSubcommand {

	public function __construct() {
		parent::__construct('disband', 'Use command to disband the faction');
	}
	...
	public function execute(CommandSender $sender, array $args) : void {
		...
		$event = new FactionDisbandEvent($faction, $session);
		$event->call();
		...
		$faction->disband();
		$sender->sendMessage(TextFormat::colorize('&cYou have disbanded the faction.'));
	}
}
